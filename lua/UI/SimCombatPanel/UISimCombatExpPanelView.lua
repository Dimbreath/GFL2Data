...
---@class UISimCombatExpPanelView : UIBaseView
UISimCombatExpPanelView = class("UISimCombatExpPanelView", UIBaseView);
UISimCombatExpPanelView.__index = UISimCombatExpPanelView


function UISimCombatExpPanelView:__InitCtrl()
...
function UISimCombatExpPanelView:InitCtrl(root)
