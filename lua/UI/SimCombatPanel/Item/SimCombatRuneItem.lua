...
SimCombatRuneItem.OrangeColor = Color(246 / 255, 113 / 255, 25 / 255, 255 / 255)
...
--function SimCombatRuneItem:SetPointColor(isComplete)
--    local color = isComplete and SimCombatRuneItem.OrangeColor or SimCombatRuneItem.WhiteColor
...
function SimCombatRuneItem:InitLine(isLastItem)
    ...
    --end
    --
    --setactive(self.mTrans_LeftLine.gameObject, isRight and (not isLastItem))
